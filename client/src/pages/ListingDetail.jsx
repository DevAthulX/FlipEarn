  ...
  return listing ? (
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex items-start max-md:flex-col gap-10">
        <div className="flex-1 max-md:w-full ">
          ...
          <div className="bg-white rounded-xl border border-gray-200 mb-5">
            <div>
              <h4 className="font-semibold text-gray-800 p-4">Account Matrix</h4>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 mb-5">
            <div>
              <h4 className="font-semibold text-gray-800 p-4">Additional Details</h4>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 text-sm">
              <div>
                <p className="text-gray-500">Niche</p>
                <p className="font-semibold capitalize">{listing.niche}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-semibold capitalize">{listing.age_range}</p>
              </div>
              <div>
                <p className="text-gray-500">Platform Verified</p>
                <p className="font-semibold capitalize">{listing.verified ? "Yes" : "No"}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-semibold capitalize">{listing.monetized ? "Enabled" : 'Disabled'}</p>
              </div>
        ...
        <div className="bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10" >
          ...
          <div className="flex items-center gap-3 mb-2 ">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{listing.owner?.owner}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <button onClick={loadChatbox} className="w-full rounded-lg bg-indigo-600 text-white py-2 hover:bg-indigo-700 transition text-sm font-medium flex items-center justify-center gap-2">
              <MessageSquareMoreIcon className="size-4" /> Chat
            </button>
            {listing.isCredentialChanged && (
              <button onClick={purchaseAccount} className="w-full  rounded-lg bg-purple-600 text-whte py-2    hover:bg-purple-700 transition text-sm font-medium flex items-center justify-center gap-2">
      ...
      <div className="bg-white border-t border-gray-200 p-4 text-center mt-28">
        <p className="text-sm text-gray-500">
          @ 2025 <span className="text-indigo-600">Athulbuilz</span>. All rights reserved.
        </p>
      </div>
    </div>
  ) : (
