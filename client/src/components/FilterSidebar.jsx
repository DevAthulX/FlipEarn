// import { ChevronDown, Filter, Option, X } from "lucide-react"
...
//         if(e.target.value) 
//         {
//             setshowFilterPhone({search: e.target.value})
...
//     }
//     const onClearFilters =(newFilters) =>{
//         if(search){
//             navigate("/marketplace")}
//             setFilters({
...
//   return (
//      <div className={` ${showFilterPhone ? "max-sm:fixed " : "max-sm:hidden"} max-sm:inset-0 z-100 max-sm:h-screen max:overflown-scroll bg-white rounded-lg shadow-sm border border-gray-200 h-fit sticky top-24 md:min-w-[300px]`}>
...
//             {/* Platform Filter */}
//             <div>
//                  <button onClick={()=> toggleSection("platform")}   className="flex items-center justify-between w-full wb-3 py-2" >
...
//             {/* price range */}
//                  <div>
//                  <button onClick={()=> toggleSection("price")}   className="flex items-center justify-between w-full wb-3 py-2">
...
//                         <input type="range" min="0" max="100000" step="100"  value={filters.maxPrice || 100000} onChange={(e) =>onFiltersChange({
//                             ...filters,
...
//             {/* Followers Range */}
//               <div>
//                  <button onClick={()=> toggleSection("followers")}   className="flex items-center justify-between w-full wb-3 py-2">
...
//             {/* Niche Filter */}
//               <div>
//                  <button onClick={()=> toggleSection("niche")}   className="flex items-center justify-between w-full wb-3 py-2">
...
//                       {niches.map((niche)=> (
//                         <option  key={niche.label} value={niche.value}>
//                             {niche.label}
//                              </option>
//                       ))}
//                    </select>
...
//             {/* Verification Status */}
//              <div>
//                  <button onClick={()=> toggleSection("status")}   className="flex items-center justify-between w-full wb-3 py-2">
...
//                                     <span className="text-sm text-shadow-gray-700">Verified accounts only</span>
//                                 </label>
//                                  <label className="flex items-center space-x-2 cursor-pointer" >
//                                     <input type="checkbox"  checked={filters.monitized || false} onChange={(e) =>onFiltersChange({...filters,monitized: e.target.checked})}/>
//                                     <span className="text-sm text-shadow-gray-700">Monitized accounts only</span>
//                                 </label>
//                     </div>
//                 )}
//             </div>
...
const FilterSidebar = ({ showFilterPhone, setshowFilterPhone, filters, setFilters }) => {
    ...
    useEffect(() => {
        const urlFilters = {
            platform: searchParams.get("platform") ? searchParams.get("platform").split(",") : null,
            maxPrice: parseInt(searchParams.get("maxPrice")) || 100000,
            minFollowers: parseInt(searchParams.get("minFollowers")) || 0,
            niche: searchParams.get("niche") || null,
            verified: searchParams.get("verified") === "true",
            monitised: searchParams.get("monitised") === "true",
        }
    ...
    useEffect(() => {
        ...
        if (filters.minFollowers && filters.minFollowers > 0) params.set("minFollowers", filters.minFollowers.toString())
